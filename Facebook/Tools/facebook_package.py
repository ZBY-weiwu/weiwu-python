...
# conf.read(r"D:\zby_spider\同步于2021-07-30\采集器\Facebook\config\config.ini",encoding="utf-8")
conf.read(parent_dir+"\..\config\config.ini",encoding="utf-8")
print("path:",parent_dir+"\..\config\config.ini")


logger_path = conf.get("Request", "timeout")
...
def Get_pubtime(url):
    ...
    proxies = {'http': '10.20.18.101:8218', 'https': 'https://10.20.18.101:8218'}
...
proxies_list = [{'http': 'http:/127.0.0.1.1:1081', 'https': 'https://127.0.0.1.1:1081'}]

if __name__ == '__main__':
    #pass
    # url = "https://facebook.com/story.php?story_fbid=1844081665756780&id=491399324358361"
    # url = "https://facebook.com/story.php?story_fbid=432321728198199&id=112862950144080"
    # print("pub_time:",int(Get_pubtime(url)))
    #print(format_pubtime(1606456800))
