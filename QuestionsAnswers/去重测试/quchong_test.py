...
class DUPClient:
    ...
    def findAndSet(self, dupclient_url, channel, expire, url):
        ...
        d["expire"] = expire
        d["target"] = url
        r = client.post(dupclient_url + '/golaxy/wde/crawler/deduplication/v1', data=json.dumps(d),
    ...
    def confirm(self, dupclient_url, channel, url, params="0"):
        ...
        d["target"] = url
        d["params"] = params
        r = client.put(dupclient_url + '/golaxy/wde/crawler/deduplication/v1', data=json.dumps(d),
                       headers={'Accept': 'application/json', 'Content-Type': 'application/json',
                                'Connection': 'keep-alive'}, timeout=5000)
    ...
    def delete(self, dupclient_url, channel, url):
        ...
        r = client.delete(url, headers={'Accept': 'application/json', 'Content-Type': 'application/json',
                                        'Connection': 'keep-alive'}, timeout=5000)
...
if __name__ == "__main__":
    client1 = DUPClient()
    # print(client1.findAndSet('http://10.20.18.100:8799', 'newscrawler', 1,
    #                          'http://istock.jrj.com.cn/article_13350882.html'))
    data = client1.getPara('http://10.20.18.100:8799', 'wenda1', '561245673710026452')
