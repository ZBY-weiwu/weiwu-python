...
import re
import os
# ua = UserAgent("./useragent.json",cache=False)
...
if __name__ == '__main__':
    code_distinguish = CodeDistinguish()
    ...
    CD = code_distinguish.get_html("https://zhidao.baidu.com/question/689373095657480732.html")
