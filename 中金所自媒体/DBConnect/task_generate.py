...
class PgDB():
    ...
    def Pg_connect(cls)->object:
        ...
        database = conf.get("Pg", "database_name")
        conn = psycopg2.connect(database=database, user=user, password=pg_password, host=hosts, port=port)
        return conn
