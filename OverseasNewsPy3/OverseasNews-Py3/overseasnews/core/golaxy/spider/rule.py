...
class GolaxyDetailAssistParseRule(GolaxyRule):
    pass
...
class GolaxyWebNewsDetailAssistParseRule(GolaxyDetailAssistParseRule):
    pass
...
class GolaxyZhikuDetailAssistParseRule(GolaxyDetailAssistParseRule):
    def __init__(self, **kwargs):
        self.cover_image_urls = None
        self.topic_list = None
        super(GolaxyZhikuDetailAssistParseRule, self).__init__(**kwargs)
