...
class Lihkg_Spider(scrapy.Spider):
    ...
    def readTaskFromJson(self, filename):
        ...
        for sub in configlist:
            cfg = spiderCFG()
            tasktext = sub
            cfg.entry_url = "https://lihkg.com/api_v2/thread/search?q={}&page={}&count=30&sort=score&type=thread"
            cfg.key_word = tasktext['key_word']
            self.cfg_list.append(cfg)
    def start_requests(self):
        for cfg in self.cfg_list:
            cfg.nextpage = 1
            tmp_url = cfg.entry_url.format(quote(cfg.key_word,'utf-8'),cfg.nextpage)
    ...
    def parse(self, response):
        ...
        for cnlist in list_item:
            ...
            item['url'] = "https://lihkg.com/search?q={}".format(cfg.key_word)
            item['match_key'] = md5.getMD5(item['title']+cfg.key_word+item['u_name']) 
    ...
    def reply_parse(self, response):    
        ...
        for cntdata in content_item:
            ...
            reply_url            = re.sub('/api_v2/thread', "", reply_url, 0, re.S|re.M|re.I) 
            ...
            reply_item['title_zh']        = cfg.get("title_zh")
